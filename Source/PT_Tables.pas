...
type
  ...
  public
    ...
    property HorizontalMetric[Index: Integer]: THorizontalMetric
      read GetHorizontalMetric;
  ...
  protected
    ...
    property PlatformSpecificID: Word read GetEncodingIDAsWord
      write SetEncodingIDAsWord;
  public
    procedure ReadStringFromStream(Stream: TStream; Length: Word);
      virtual; abstract;
  ...
  private
    ...
    // Field is split into two bit fields of 96 and 36 bits each. The low 96 bits are used to specify the Unicode blocks encompassed by the font file. The high 32 bits are used to specify the character or script sets covered by the font file. Bit assignments are pending. Set to 01
  ...
  public
    ...
    property SupportsPhoneticExtensions: Boolean
      read GetSupportsPhoneticExtensions;
    property SupportsPhoneticExtensionsSupplement: Boolean
      read GetSupportsPhoneticExtensionsSupplement;
    property SupportsSpacingModifierLetters: Boolean
      read GetSupportsSpacingModifierLetters;
    property SupportsModifierToneLetters: Boolean
      read GetSupportsModifierToneLetters;
    property SupportsCombiningDiacriticalMarks: Boolean
      read GetSupportsCombiningDiacriticalMarks;
    property SupportsCombiningDiacriticalMarksSupplement: Boolean
      read GetSupportsCombiningDiacriticalMarksSupplement;
    ...
    property SupportsCyrillicSupplement: Boolean
      read GetSupportsCyrillicSupplement;
    property SupportsCyrillicExtendedA: Boolean
      read GetSupportsCyrillicExtendedA;
    property SupportsCyrillicExtendedB: Boolean
      read GetSupportsCyrillicExtendedB;
    ...
    property SupportsGeorgianSupplement: Boolean
      read GetSupportsGeorgianSupplement;
    property SupportsBalinese: Boolean read GetSupportsBalinese;
    property SupportsHangulJamo: Boolean read GetSupportsHangulJamo;
    property SupportsLatinExtendedAdditional: Boolean
      read GetSupportsLatinExtendedAdditional;
    ...
    property SupportsGeneralPunctuation: Boolean
      read GetSupportsGeneralPunctuation;
    property SupportsSupplementalPunctuation: Boolean
      read GetSupportsSupplementalPunctuation;
    property SupportsSuperscriptsAndSubscripts: Boolean
      read GetSupportsSuperscriptsAndSubscripts;
    property SupportsCurrencySymbols: Boolean read GetSupportsCurrencySymbols;
    property SupportsCombiningDiacriticalMarksForSymbols: Boolean
      read GetSupportsCombiningDiacriticalMarksForSymbols;
    property SupportsLetterlikeSymbols: Boolean
      read GetSupportsLetterlikeSymbols;
    property SupportsNumberForms: Boolean read GetSupportsNumberForms;
    property SupportsArrows: Boolean read GetSupportsArrows;
    property SupportsSupplementalArrowsA: Boolean
      read GetSupportsSupplementalArrowsA;
    property SupportsSupplementalArrowsB: Boolean
      read GetSupportsSupplementalArrowsB;
    property SupportsMiscellaneousSymbolsAndArrows: Boolean
      read GetSupportsMiscellaneousSymbolsAndArrows;
    property SupportsMathematicalOperators: Boolean
      read GetSupportsMathematicalOperators;
    property SupportsSupplementalMathematicalOperators: Boolean
      read GetSupportsSupplementalMathematicalOperators;
    property SupportsMiscellaneousMathematicalSymbolsA: Boolean
      read GetSupportsMiscellaneousMathematicalSymbolsA;
    property SupportsMiscellaneousMathematicalSymbolsB: Boolean
      read GetSupportsMiscellaneousMathematicalSymbolsB;
    property SupportsMiscellaneousTechnical: Boolean
      read GetSupportsMiscellaneousTechnical;
    property SupportsControlPictures: Boolean read GetSupportsControlPictures;
    property SupportsOpticalCharacterRecognition: Boolean
      read GetSupportsOpticalCharacterRecognition;
    property SupportsEnclosedAlphanumerics: Boolean
      read GetSupportsEnclosedAlphanumerics;
    ...
    property SupportsMiscellaneousSymbols: Boolean
      read GetSupportsMiscellaneousSymbols;
    property SupportsDingbats: Boolean read GetSupportsDingbats;
    property SupportsCJKSymbolsAndPunctuation: Boolean
      read GetSupportsCJKSymbolsAndPunctuation;
    property SupportsHiragana: Boolean read GetSupportsHiragana;
    property SupportsKatakana: Boolean read GetSupportsKatakana;
    property SupportsKatakanaPhoneticExtensions: Boolean
      read GetSupportsKatakanaPhoneticExtensions;
    ...
    property SupportsHangulCompatibilityJamo: Boolean
      read GetSupportsHangulCompatibilityJamo;
    property SupportsPhagsPa: Boolean read GetSupportsPhagsPa;
    property SupportsEnclosedCJKLettersAndMonths: Boolean
      read GetSupportsEnclosedCJKLettersAndMonths;
    ...
    property SupportsCJKUnifiedIdeographs: Boolean
      read GetSupportsCJKUnifiedIdeographs;
    property SupportsCJKRadicalsSupplement: Boolean
      read GetSupportsCJKRadicalsSupplement;
    property SupportsKangxiRadicals: Boolean read GetSupportsKangxiRadicals;
    property SupportsIdeographicDescriptionCharacters: Boolean
      read GetSupportsIdeographicDescriptionCharacters;
    property SupportsCJKUnifiedIdeographsExtensionA: Boolean
      read GetSupportsCJKUnifiedIdeographsExtensionA;
    property SupportsCJKUnifiedIdeographsExtensionB: Boolean
      read GetSupportsCJKUnifiedIdeographsExtensionB;
    property SupportsKanbun: Boolean read GetSupportsKanbun;
    property SupportsPrivateUseAreaPlane0: Boolean
      read GetSupportsPrivateUseAreaPlane0;
    property SupportsCJKStrokes: Boolean read GetSupportsCJKStrokes;
    property SupportsCJKCompatibilityIdeographs: Boolean
      read GetSupportsCJKCompatibilityIdeographs;
    property SupportsCJKCompatibilityIdeographsSupplement: Boolean
      read GetSupportsCJKCompatibilityIdeographsSupplement;
    property SupportsAlphabeticPresentationForms: Boolean
      read GetSupportsAlphabeticPresentationForms;
    property SupportsArabicPresentationFormsA: Boolean
      read GetSupportsArabicPresentationFormsA;
    property SupportsCombiningHalfMarks: Boolean
      read GetSupportsCombiningHalfMarks;
    property SupportsVerticalForms: Boolean read GetSupportsVerticalForms;
    property SupportsCJKCompatibilityForms: Boolean
      read GetSupportsCJKCompatibilityForms;
    property SupportsSmallFormVariants: Boolean
      read GetSupportsSmallFormVariants;
    property SupportsArabicPresentationFormsB: Boolean
      read GetSupportsArabicPresentationFormsB;
    property SupportsHalfwidthAndFullwidthForms: Boolean
      read GetSupportsHalfwidthAndFullwidthForms;
    ...
    property SupportsEthiopicSupplement: Boolean
      read GetSupportsEthiopicSupplement;
    ...
    property SupportsUnifiedCanadianAboriginalSyllabics: Boolean
      read GetSupportsUnifiedCanadianAboriginalSyllabics;
    ...
    property SupportsByzantineMusicalSymbols: Boolean
      read GetSupportsByzantineMusicalSymbols;
    property SupportsMusicalSymbols: Boolean read GetSupportsMusicalSymbols;
    property SupportsAncientGreekMusicalNotation: Boolean
      read GetSupportsAncientGreekMusicalNotation;
    property SupportsMathematicalAlphanumericSymbols: Boolean
      read GetSupportsMathematicalAlphanumericSymbols;
    property SupportsPrivateUsePlane15: Boolean
      read GetSupportsPrivateUsePlane15;
    property SupportsPrivateUsePlane16: Boolean
      read GetSupportsPrivateUsePlane16;
    property SupportsVariationSelectors: Boolean
      read GetSupportsVariationSelectors;
    property SupportsVariationSelectorsSupplement: Boolean
      read GetSupportsVariationSelectorsSupplement;
    ...
    property SupportsYijingHexagramSymbols: Boolean
      read GetSupportsYijingHexagramSymbols;
    ...
    property SupportsAncientGreekNumbers: Boolean
      read GetSupportsAncientGreekNumbers;
    ...
    property SupportsTaiXuanJingSymbols: Boolean
      read GetSupportsTaiXuanJingSymbols;
    property SupportsCuneiform: Boolean read GetSupportsCuneiform;
    property SupportsCuneiformNumbersAndPunctuation: Boolean
      read GetSupportsCuneiformNumbersAndPunctuation;
    property SupportsCountingRodNumerals: Boolean
      read GetSupportsCountingRodNumerals;
  ...
  public
    ...
    property SupportsLatin2EasternEurope: Boolean
      read GetSupportsLatin2EasternEurope;
    property SupportsCyrillic: Boolean read GetSupportsCyrillic;
    ...
    property SupportsChineseSimplified: Boolean
      read GetSupportsChineseSimplified;
    property SupportsKoreanWansung: Boolean read GetSupportsKoreanWansung;
    property SupportsChineseTraditional: Boolean
      read GetSupportsChineseTraditional;
    property SupportsKoreanJohab: Boolean read GetSupportsKoreanJohab;
    property SupportsMacintoshCharacterSet: Boolean
      read GetSupportsMacintoshCharacterSet;
    property SupportsOEMCharacter: Boolean read GetSupportsOEMCharacter;
    property SupportsSymbolCharacterSet: Boolean
      read GetSupportsSymbolCharacterSet;
    ...
    property SupportsAlternativeArabic: Boolean
      read GetSupportsAlternativeArabic;
    property SupportsMSDOSCanadianFrench: Boolean
      read GetSupportsMSDOSCanadianFrench;
    property SupportsAlternativeHebrew: Boolean
      read GetSupportsAlternativeHebrew;
  ...
  public
    ...
    property AddendumTable: TPascalTypeOS2AddendumTable read FAddendumTable
      write SetAddendumTable;
    property AverageCharacterWidth: SmallInt read FAverageCharacterWidth
      write SetAverageCharacterWidth;
    property CodePageRange: TPascalTypeOS2CodePageRangeTable read FCodePageRange
      write SetCodePageRange;
    property FontEmbeddingFlags: Word read FFontEmbeddingFlags
      write SetFontEmbeddingFlags;
    property FontEmbeddingRights: TOS2FontEmbeddingRights
      read GetFontEmbeddingRights write SetFontEmbeddingRights;
    property FontFamilyClassID: Byte read GetFontFamilyClassID
      write SetFontFamilyClassID;
    property FontFamilySubClassID: Byte read GetFontFamilySubClassID
      write SetFontFamilySubClassID;
    ...
    property FontSelectionFlags: TOS2FontSelectionFlags
      read GetFontSelectionFlags write SetFontSelectionFlags;
    ...
    property StrikeoutPosition: SmallInt read FStrikeoutPosition
      write SetStrikeoutPosition;
    property StrikeoutSize: SmallInt read FStrikeoutSize write SetStrikeoutSize;
    property SubScriptOffsetX: SmallInt read FSubScriptOffsetX
      write SetSubScriptOffsetX;
    property SubscriptOffsetY: SmallInt read FSubscriptYOffsetY
      write SetSubscriptOffsetY;
    property SubscriptSizeX: SmallInt read FSubscriptSizeX
      write SetSubscriptSizeX;
    property SubscriptSizeY: SmallInt read FSubscriptSizeY
      write SetSubscriptSizeY;
    property SuperscriptOffsetX: SmallInt read FSuperscriptOffsetX
      write SetSuperscriptOffsetX;
    property SuperscriptOffsetY: SmallInt read FSuperscriptOffsetY
      write SetSuperscriptOffsetY;
    property SuperscriptSizeX: SmallInt read FSuperscriptSizeX
      write SetSuperscriptXSizeX;
    property SuperscriptSizeY: SmallInt read FSuperscriptSizeY
      write SetSuperscriptYSizeY;
    property TypographicAscent: SmallInt read FTypographicAscent
      write SetTypographicAscent;
    property TypographicDescent: SmallInt read FTypographicDescent
      write SetTypographicDescent;
    property TypographicLineGap: SmallInt read FTypographicLineGap
      write SetTypographicLineGap;
    property UnicodeFirstCharacterIndex: Word read FUnicodeFirstCharIndex
      write SetUnicodeFirstCharIndex;
    property UnicodeLastCharacterIndex: Word read FUnicodeLastCharIndex
      write SetUnicodeLastCharIndex;
    property UnicodeRange: TPascalTypeUnicodeRangeTable read FUnicodeRangeTable
      write FUnicodeRangeTable;
    property Version: Word read FVersion write SetVersion;
    property Weight: Word read FWeight write SetWeight;
    property WeightClass: TOS2WeightClass read GetWeightClass
      write SetWeightClass;
...
procedure RegisterPascalTypePanoses(PanoseClasses
  : array of TCustomPascalTypePanoseClass);
function FindPascalTypePanoseByType(PanoseType: Byte)
  : TCustomPascalTypePanoseClass;
    ...
    begin
      ...
      begin
        ...
        FCharacterMap := TCustomPascalTypeCharacterMapClass
          (Self.FCharacterMap.ClassType).Create;
      end;
...
function TPascalTypeCharacterMapUnicodeDirectory.GetEncodingID
  : TUnicodeEncodingID;
begin
...
function TPascalTypeCharacterMapMacintoshDirectory.GetEncodingID
  : TAppleEncodingID;
begin
...
begin
  ...
  begin
    ...
    for MtxIndex := HorHead.NumOfLongHorMetrics to Length
      (FHorizontalMetrics) - 1 do
      with FHorizontalMetrics[MtxIndex] do
      begin
        // read left side bearing
        Bearing := ReadSwappedSmallInt(Stream);
...
function TPascalTypeHorizontalMetricsTable.GetHorizontalMetric(Index: Integer)
  : THorizontalMetric;
begin
  if (Index >= 0) and (Index < Length(FHorizontalMetrics)) then
...
begin
  if Dest is Self.ClassType then
    ...
    begin
      ...
      begin
        NameTableClass := TTrueTypeFontNamePlatformClass
          (Self.FNameSubTables[NameTableIndex].ClassType);

        // create name table
        FNameSubTables[NameTableIndex] := NameTableClass.Create;

        // assign name table
        FNameSubTables[NameTableIndex]
          .Assign(Self.FNameSubTables[NameTableIndex]);
      end;
    end
  else
    inherited;
...
begin
  if Dest is Self.ClassType then
    with TCustomPascalTypePanoseTable(Dest) do
      FData := Self.FData
  else
    inherited;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsAlphabeticPresentationForms: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 30)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsAncientGreekMusicalNotation: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsArabicPresentationFormsA: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 31)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsArabicPresentationFormsB: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsByzantineMusicalSymbols: Boolean;
begin
  Result := (FUnicodeRange[2] and (1 shl 24)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsCJKCompatibilityIdeographs: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 29)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsCJKCompatibilityIdeographsSupplement: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 29)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsCJKSymbolsAndPunctuation: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsCJKUnifiedIdeographsExtensionA: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 27)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsCJKUnifiedIdeographsExtensionB: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 27)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsCombiningDiacriticalMarks: Boolean;
begin
  Result := (FUnicodeRange[0] and (1 shl 6)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsCombiningDiacriticalMarksForSymbols: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 2)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsCombiningDiacriticalMarksSupplement: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsCuneiformNumbersAndPunctuation: Boolean;
begin
  Result := (FUnicodeRange[3] and (1 shl 14)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsEnclosedCJKLettersAndMonths: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsHalfwidthAndFullwidthForms: Boolean;
begin
  Result := (FUnicodeRange[2] and (1 shl 4)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsHangulCompatibilityJamo: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsIdeographicDescriptionCharacters: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 27)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsKatakanaPhoneticExtensions: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsLatinExtendedAdditional: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsMathematicalAlphanumericSymbols: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsMiscellaneousMathematicalSymbolsA: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 6)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsMiscellaneousMathematicalSymbolsB: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 6)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsMiscellaneousSymbolsAndArrows: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 5)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.GetSupportsMiscellaneousTechnical
  : Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsOpticalCharacterRecognition: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsPhoneticExtensionsSupplement: Boolean;
begin
  Result := (FUnicodeRange[0] and (1 shl 4)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.GetSupportsSpacingModifierLetters
  : Boolean;
begin
  Result := (FUnicodeRange[0] and (1 shl 4)) <> 0;
end;
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsSuperscriptsAndSubscripts: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsSupplementalMathematicalOperators: Boolean;
begin
  Result := (FUnicodeRange[1] and (1 shl 6)) <> 0;
end;

function TPascalTypeUnicodeRangeTable.
  GetSupportsSupplementalPunctuation: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsUnifiedCanadianAboriginalSyllabics: Boolean;
begin
...
function TPascalTypeUnicodeRangeTable.
  GetSupportsVariationSelectorsSupplement: Boolean;
begin
  Result := (FUnicodeRange[2] and (1 shl 27)) <> 0;
end;
...
function TPascalTypeOS2CodePageRangeTable.GetSupportsChineseTraditional
  : Boolean;
begin
...
function TPascalTypeOS2CodePageRangeTable.
  GetSupportsLatin2EasternEurope: Boolean;
begin
  Result := (FCodePageRange[0] and 2) <> 0;
end;

function TPascalTypeOS2CodePageRangeTable.
  GetSupportsMacintoshCharacterSet: Boolean;
begin
...
function TPascalTypeOS2CodePageRangeTable.
  GetSupportsMSDOSCanadianFrench: Boolean;
begin
...
function TPascalTypeOS2CodePageRangeTable.GetSupportsSymbolCharacterSet
  : Boolean;
begin
...
procedure TPascalTypeOS2Table.SetPanose(const Value
  : TCustomPascalTypePanoseTable);
begin
...
procedure TPascalTypeOS2Table.SetFontEmbeddingRights
  (const Value: TOS2FontEmbeddingRights);
begin
...
function IsPascalTypePanoseRegistered(PanoseClass
  : TCustomPascalTypePanoseClass): Boolean;
var
...
RegisterPascalTypeTables([TPascalTypeHeaderTable, TPascalTypeCharacterMapTable,
  TPascalTypeHorizontalHeaderTable, TPascalTypeHorizontalMetricsTable,
  TPascalTypeNameTable, TPascalTypeMaximumProfileTable,
  TPascalTypePostscriptTable, TPascalTypeOS2Table]);
