...
begin
  case Index of
    ...
    105:
      Result := 'quotedblleft';
    106:
      Result := 'guillemotleft';
    107:
      Result := 'guilsinglleft';
    108:
      Result := 'guilsinglright';
    109:
      Result := 'fi';
    110:
      Result := 'fl';
    ...
    113:
      Result := 'daggerdbl';
    114:
      Result := 'periodcentered';
    115:
      Result := 'paragraph';
    116:
      Result := 'bullet';
    117:
      Result := 'quotesinglbase';
    118:
      Result := 'quotedblbase';
    119:
      Result := 'quotedblright';
    120:
      Result := 'guillemotright';
    121:
      Result := 'ellipsis';
    122:
      Result := 'perthousand';
    ...
    229:
      Result := 'exclamsmall';
    230:
      Result := 'Hungarumlautsmall';
    231:
      Result := 'dollaroldstyle';
    232:
      Result := 'dollarsuperior';
    233:
      Result := 'ampersandsmall';
    234:
      Result := 'Acutesmall';
    235:
      Result := 'parenleftsuperior';
    236:
      Result := 'parenrightsuperior';
    237:
      Result := 'twodotenleader';
    238:
      Result := 'onedotenleader';
    239:
      Result := 'zerooldstyle';
    240:
      Result := 'oneoldstyle';
    ...
    245:
      Result := 'sixoldstyle';
    246:
      Result := 'sevenoldstyle';
    247:
      Result := 'eightoldstyle';
    248:
      Result := 'nineoldstyle';
    249:
      Result := 'commasuperior';
    250:
      Result := 'threequartersemdash';
    251:
      Result := 'periodsuperior';
    252:
      Result := 'questionsmall';
    253:
      Result := 'asuperior';
    254:
      Result := 'bsuperior';
    ...
    268:
      Result := 'ffl';
    269:
      Result := 'parenleftinferior';
    270:
      Result := 'parenrightinferior';
    271:
      Result := 'Circumflexsmall';
    272:
      Result := 'hyphensuperior';
    273:
      Result := 'Gravesmall';
    274:
      Result := 'Asmall';
    ...
    308:
      Result := 'Zcaronsmall';
    309:
      Result := 'Dieresissmall';
    310:
      Result := 'Brevesmall';
    311:
      Result := 'Caronsmall';
    312:
      Result := 'Dotaccentsmall';
    313:
      Result := 'Macronsmall';
    314:
      Result := 'figuredash';
    315:
      Result := 'hypheninferior';
    316:
      Result := 'Ogoneksmall';
    317:
      Result := 'Ringsmall';
    ...
    329:
      Result := 'sixsuperior';
    330:
      Result := 'sevensuperior';
    331:
      Result := 'eightsuperior';
    332:
      Result := 'ninesuperior';
    333:
      Result := 'zeroinferior';
    ...
    339:
      Result := 'sixinferior';
    340:
      Result := 'seveninferior';
    341:
      Result := 'eightinferior';
    342:
      Result := 'nineinferior';
    343:
      Result := 'centinferior';
    344:
      Result := 'dollarinferior';
    345:
      Result := 'periodinferior';
    346:
      Result := 'commainferior';
    347:
      Result := 'Agravesmall';
    348:
      Result := 'Aacutesmall';
    349:
      Result := 'Acircumflexsmall';
    350:
      Result := 'Atildesmall';
    351:
      Result := 'Adieresissmall';
    352:
      Result := 'Aringsmall';
    353:
      Result := 'AEsmall';
    354:
      Result := 'Ccedillasmall';
    355:
      Result := 'Egravesmall';
    356:
      Result := 'Eacutesmall';
    357:
      Result := 'Ecircumflexsmall';
    358:
      Result := 'Edieresissmall';
    359:
      Result := 'Igravesmall';
    360:
      Result := 'Iacutesmall';
    361:
      Result := 'Icircumflexsmall';
    362:
      Result := 'Idieresissmall';
    363:
      Result := 'Ethsmall';
    364:
      Result := 'Ntildesmall';
    ...
    366:
      Result := 'Oacutesmall';
    367:
      Result := 'Ocircumflexsmall';
    368:
      Result := 'Otildesmall';
    369:
      Result := 'Odieresissmall';
    370:
      Result := 'OEsmall';
    371:
      Result := 'Oslashsmall';
    ...
    373:
      Result := 'Uacutesmall';
    374:
      Result := 'Ucircumflexsmall';
    375:
      Result := 'Udieresissmall';
    376:
      Result := 'Yacutesmall';
    377:
      Result := 'Thornsmall';
    378:
      Result := 'Ydieresissmall';
    379:
      Result := '001.000';
    380:
      Result := '001.001';
          ...
          begin
            ...
            repeat
              ...
              case Nibble of
                ...
                raise EPascalTypeError.Create(RCStrCFFErrorWrongNibble);
              end;
...
begin
  ...
  for OffIndex := 0 to Length(Offsets) - 1 do
    case OffSize of
      ...
      2:
        begin
          Stream.Read(Offset[0], 2);
          Offsets[OffIndex] := (Offset[0] shl 8) + Offset[1];
        end;
      3:
        begin
          Stream.Read(Offset[0], 3);
          Offsets[OffIndex] := (Offset[0] shl 16) + (Offset[1] shl 8) +
            Offset[2];
        end;
      4:
        begin
          Stream.Read(Offset[0], 4);
          Offsets[OffIndex] := (Offset[0] shl 24) + (Offset[1] shl 16) +
            (Offset[2] shl 8) + Offset[3];
        end;
    end;
...
begin
  ...
  if (Index < 0) or (Index >= Length(FFontNames)) then
    raise EPascalTypeError.CreateFmt(RCStrIndexOutOfBounds, [Index]);
...
begin
  if FNameTable.FontNameCount > 0 then
    Result := FNameTable.FontName[0]
  else
    Result := '';
end;
...
function IsOperatorClassRegistered(OperatorClass
  : TPascalTypePostscriptDictOperatorClass): Boolean;
var
