...
*)
  ...
  TPascalTypeGlyphMetamorphosisTable = class(TCustomPascalTypeNamedTable)
  private
  ...
  TPascalTypeExtendedGlyphMetamorphosisTable = class(TCustomPascalTypeNamedTable)
  private
    FVersion : TFixedPoint;
    procedure SetVersion(const Value: TFixedPoint);
  protected
  ...
  TPascalTypeOpticalBoundsTable = class(TCustomPascalTypeNamedTable)
  private
    FVersion : TFixedPoint;
    FFormat  : Word;
    procedure SetVersion(const Value: TFixedPoint);
...
procedure TPascalTypeGlyphMetamorphosisTable.SetVersion(
...
procedure TPascalTypeGlyphMetamorphosisTable.VersionChanged;
begin
 Changed;
end;
...
procedure TPascalTypeExtendedGlyphMetamorphosisTable.SetVersion(
  const Value: TFixedPoint);
begin
 if (FVersion.Value <> Value.Value) or
    (FVersion.Fract <> Value.Fract) then
...
procedure TPascalTypeExtendedGlyphMetamorphosisTable.VersionChanged;
begin
 Changed;
end;
...
procedure TPascalTypeOpticalBoundsTable.SetVersion(
  const Value: TFixedPoint);
begin
 if (FVersion.Value <> Value.Value) or
    (FVersion.Fract <> Value.Fract) then
...
procedure TPascalTypeOpticalBoundsTable.VersionChanged;
begin
 Changed;
end;
...
initialization
  RegisterPascalTypeTables([TPascalTypeDigitalSignatureTable,
    ...
    TPascalTypeLinearThresholdTable, TPascalTypeGlyphMetamorphosisTable,
    TPascalTypeExtendedGlyphMetamorphosisTable, TPascalTypeOpticalBoundsTable,
    TPascalTypePCL5Table, TPascalTypeVerticalDeviceMetricsTable,
    TPascalTypeVerticalHeaderTable, TPascalTypeVerticalMetricsTable]);
