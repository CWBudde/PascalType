...
procedure TPascalTypeLatinHandWrittenPanoseTable.SetAspectRatio
  (const Value: Byte);
begin
  if FData[3] <> Value then
  begin
...
procedure TPascalTypeLatinDecorativePanoseTable.SetSerifVariant
  (const Value: Byte);
begin
  if FData[4] <> Value then
  begin
...
procedure TPascalTypeLatinDecorativePanoseTable.SetRangeOfCharacters
  (const Value: Byte);
begin
  if FData[8] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioContrast
  (const Value: Byte);
begin
  if FData[3] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioCharacter94
  (const Value: Byte);
begin
  if FData[4] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioCharacter119
  (const Value: Byte);
begin
  if FData[5] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioCharacter157
  (const Value: Byte);
begin
  if FData[6] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioCharacter163
  (const Value: Byte);
begin
  if FData[7] <> Value then
  begin
...
procedure TPascalTypeLatinSymbolPanoseTable.SetAspectRatioCharacter211
  (const Value: Byte);
begin
  if FData[8] <> Value then
  begin
